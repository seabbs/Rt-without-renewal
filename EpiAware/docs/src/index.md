...
- Want to chat with someone about `EpiAware`? Post on our [GitHub Discussions](https://github.com/seabbs/EpiAware/discussions).
- Want to contribute to `EpiAware`? Check out our [Developer documentation](@ref developer).
- Want to see our code? Check out our [GitHub Repository](https://github.com/seabbs/EpiAware/tree/main/EpiAware).
